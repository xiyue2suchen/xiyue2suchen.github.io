    ...
    const i18n = {
        ...
        en: {
            ...
            letterTitles: {
                ...
                60: 'Network Delay Missed You',
                61: 'Omnivore Music Taste',
                62: 'Cloudy Grassland',
                63: 'Iron Woman',
                64: 'Single Room Bliss',
            ...
            letterPreviews: {
                ...
                58: 'Missed You Again',
                59: 'The Chihiro Sketch',
                60: 'It was my network delay, saw your candle notification at 1pm too',
                61: 'Never seen Hua Chenyu concert videos, an omnivore for music',
                62: 'The mountain near home is a grassy kind called Cloud Grassland',
                63: 'The certificate itself is easy, doing it while prepping for everything else is impressive',
                64: 'Roommates all left for internships, single dorm is amazing',
...
`
        ...
        {
            id: 58, date: '2026-07-01', icon: '👻',
            title: '又错过了你',
            preview: '我今天看到你了，一点左右，你在吃粽子，我立马上线，然后看到你在锅旁边睡着了，过了几分钟后你不见了',
            stamp: '🌙',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
...
|            `
        ...
        {
            id: 60, date: '2026-07-05', icon: '🐱',
            title: '网络延迟错过了你',
            preview: '是我网络延迟了，我看到心火提示也是一点左右，原来是关机了',
            stamp: '📡',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
                <p>是我网络延迟了，我看到心火提示也是在一点左右，显示的是现在，可恶</p>
<p>其实这个烛火二十分钟左右挂满，而且有15根蜡烛呢</p>
<p>我就说你怎么睡着就不见了，还以为你串走了，回家一看不在线了，我还很疑惑你下线的话会碰到手机不可能还带着睡觉图标，原来是关机了</p>
<p>那我这几天晚上多多上线</p>
|            `
        },
        {
            id: 61, date: '2026-07-05', icon: '🎵',
            title: '杂食动物听歌',
            preview: '华晨宇的演唱会我没刷到过，我也是杂食动物只要好听就喜欢',
            stamp: '🎶',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
                <p>华晨宇的演唱会我没刷到过<br>我也是杂食动物啊哈哈哈哈只要好听就喜欢</p>
|            `
        },
        {
            id: 62, date: '2026-07-05', icon: '🏔️',
            title: '云上草原',
            preview: '我们家的山是草原山，定位叫云上草原，我很喜欢这个名字🥰',
            stamp: '⛰️',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
                <p>我们家这边的山是那种草原山，离我家开车需要两个小时左右，基本是土组成的，但好像也有石头组成，上面有雪但不多，我爬的小一点的山然后下去挑战爬最高的，结果快到了的时候看着还是好遥远，天也要黑了，我就下去了，我定位那里的时候名字叫云上草原，我很喜欢这个名字🥰</p>
|            `
        },
        {
            id: 63, date: '2026-07-05', icon: '🥇',
            title: '钢铁般的女人',
            preview: '教资或许不难，难的是你同时备考好多还能这么短时间内拿下👍🏻',
            stamp: '🎓',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
                <p>教资或许不难，难的是你要同时备考好多东西还能这么短时间内拿下，还是很厉害的👍🏻</p>
                <div class="letter-photo"><img src="images/email102_30.png" alt="曦月的教师资格证"></div>
|            `
        },
        {
            id: 64, date: '2026-07-05', icon: '😴',
            title: '单人间爽睡',
            preview: '室友都自主自习了，下学期就我一个，单人间爽翻了😍',
            stamp: '🛏️',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
                <p>我室友都自主自习了，下学期是不会回来了的，下下学期毕业答辩可能会回来<br>我也觉得单人间爽翻了哈哈哈哈哈</p>
<p>我下学期不上课了呢，要实习，实习的幼儿园离学校很近过一个红绿灯拐个弯就到，我运气真好，被安排到离学校最近的幼儿园</p>
<p>我对声音很敏感</p>
<p>我也是哈哈哈，早课闹钟响了我就关掉继续睡就很香</p>
|            `
        },
        {
            id: 65, date: '2026-07-05', icon: '🐱',
            title: '小猫对零食敏感',
            preview: '我家猫对开零食包装的声音非常敏感，听到就喵喵个不停',
            stamp: '🎨',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
                <p>我家猫真是对开零食包装的声音非常敏感，听到就喵喵个不停一直伸嘴要吃那个美术老师还开玩笑说想举办个抽象绘画作品，把我们班的作品拿去参赛呢哈哈哈哈哈</p>
                <div class="letter-photo"><img src="images/email104_31.jpg" alt="苏晨的简笔画1"></div>
                <div class="letter-photo"><img src="images/email104_32.jpg" alt="苏晨的简笔画2"></div>
                <div class="letter-photo"><img src="images/email104_33.jpg" alt="苏晨的简笔画3"></div>
                <div class="letter-photo"><img src="images/email104_34.jpg" alt="苏晨的简笔画4"></div>
|            `
        },
        {
            id: 66, date: '2026-07-05', icon: '🤖',
            title: 'AI风口与小说创作',
            preview: 'AI确实是风口，我会做甜中带虐虐中带甜的小说剧情',
            stamp: '📖',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
                <p>现在AI确实是个风口，我们学会了应该也算是吃上时代红利，确实值得一试，做起来了收入应该会很可观</p>
<p>我可能会做甜中带虐 虐中带甜的小说剧情吧<br>因为太甜感觉我会高血糖，太虐怕哭死😅</p>
|            `
        },
        {
            id: 67, date: '2026-07-05', icon: '🌊',
            title: '新疆旅行与湖泊',
            preview: '新疆选好时间去真的很重要，喀什的湖水像蓝色宝石🥰',
            stamp: '🏔️',
            content: `
                <div class="letter-from" data-i18n-raw="fromChen">—— 来自 苏晨 ——</div>
